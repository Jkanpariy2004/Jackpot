        ...
        <div className="w-[100%] h-[490px] relative">
            ...
            <div className="absolute w-[100%] h-[100%]">
                <div className='w-full text-center'>
                    <h1 className='text-white image-text font-normal text-[28px] sm:text-[32px] md:text-[32px] w-[90%] sm:w-[292px] mt-[20px] sm:mt-[40px] mx-auto border-b-2 border-[#FF0052]'>
                        MINI - Game Section
                    </h1>
                </div>
                    ...
                    <div className='font-header'>
                        ...
                        <div className="flex flex-col lg:flex-row justify-center">
                            ...
                            <div className='w-[40%] text-center '>
                                <div className='w-[100%] h-[290px] bg-[#FF0052] rounded-lg p-[20px] text-white'>
