    ...
    return (
        <div className='mx-5'>
            <div className="w-full text-center mt-[4rem]">
                <p className="image-text font-normal text-[24px] lg:text-[36px] border-b-2 border-[#FF0052] w-[293px] lg:w-[435px] mx-auto">
            ...
            <div className="w-full text-center mt-[2rem] font-header">
                <button className="bg-[#FF0052] w-[135px] lg:w-[225px] h-[28px] lg:h-[46px] rounded-sm lg:rounded-lg">
